...
@foreach (Cart::content() as $item)
                    ...
                    <a class="btn btn-increase" href="#" wire:clieck.prevent="increaseQuantity('{{$item->rowId}}')"></a>
                    <a class="btn btn-reduce" href="#" wire:clieck.prevent="decreaseQuantity('{{$item->rowId}}')"></a>
